...
export const DealCard: FC<DealCardProps> = ({ deal }) => {
  ...
  return (
    ...
    >
      <Card className="flex flex-col justify-start gap-3 overflow-hidden border bg-card text-card-foreground shadow-sm transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 h-full pt-0 pb-1">
